...
```js
<script src="https://cdn.jsdelivr.net/npm/darkyjs@1.1.0/1.1.0/darky.min.js"></script>
<script>
...
* **buttonShadow:** (String) CSS value for the button shadow. Defaults to "0 0.2rem 0.5rem 0.1rem rgba(0,0,0,0.4)".
