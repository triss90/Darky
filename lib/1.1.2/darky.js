 ...
 *  Web: https://darky.app
 *	Version: 1.1.2
 *	Created by: Tristan White - https://triss.dev
 */
...
(function () {
	...
	const Darky = function (opts) {
		...
		this.buttonShadow = this.options.buttonShadow;
		...
		this.css = `
			...
			.darkmode--background {
				...
				pointer-events: none;
				transition: all calc(${this.time} / 1.5) ease;
				...
				.darkmode--background.darkmode--triggered {
					border-radius: 0;
					transform: scale(100);
					transition: all calc(${this.time} * 1.3) ease;
					box-shadow: none;
	...
	Darky.prototype.enable = function () {
		...
		backdropEl = document.querySelector(".darkmode--backdrop");
