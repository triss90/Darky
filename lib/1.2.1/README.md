...
* **buttonShadow:** (string) CSS value for setting the button shadow. Defaults to "0 0.2rem 0.5rem 0.1rem rgba(0,0,0,0.4)".
* **zIndex:** (Int) CSS value for setting the z-index. Defaults to "9998".
